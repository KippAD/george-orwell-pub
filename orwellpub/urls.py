...
urlpatterns = [
    ...
    path('accounts/myaccount', views.AccountPage.as_view(), name='account'),
    path('accounts/update/<int:pk>', views.UpdateBooking.as_view(), name='update-booking'),
    path('accounts/delete/<int:pk>', views.DeleteBooking.as_view(), name='delete-booking'),
    path('accounts/contact/', views.DeleteBooking.as_view(), name='contact-form'),
